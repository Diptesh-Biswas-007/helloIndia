...
<head>
    <meta charset="utf-8">
    <title>Ladakh.helloIndia.com</title>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Ladakh</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Ladakh</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/packages img/ladakhpage3.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">Thrilling Leh Ladakh Tour with Pangong Lake Overview.</h2>
                            <p align="justify"> Get ready to make your dream of going on a road trip in Ladakh come true
                                where one would be experiencing the fusion of thrill, serene beauty and culture of The
                                "Land of High Passes", as the entire tour is exclusively elected by Hello INDIA's
                                outdoor experts. </p>
                            <p align="justify">A wonderful drive through Leh-Ladakh, a land covered with snow-capped
                                mountains and the highest motorable passes, makes you feel at the top of the world. The
                                unique thing about the Ladakh terrain is that it has mountains, forests, deserts, lakes,
                                rivers, waterfalls in one beautiful and dynamic geography.</p>
                            <h4 class="mb-3">Day-1: Spectacular Highlights!!</h4>
                            <img class="img-fluid w-50 float-left mr-4 mb-2"
                                src="img/packages img/monasteries-of-ladakh.jpg">
                            <p align="justify"> Hall of fame, Magnetic Hill,Confluence of Indus and Zanskar, Alchi, Nubra valley,
                                Khardongla, Changla pass, Pangong Lake,Shey, Thiksay, Shanti Stupa, Leh Market, Pathar
                                Sahib Gurduwara,Sand Dune Overview: Some jaw dropping attractions awaits your arrival in
                                Ladakh and this tour package shall have them all in your kitty!</p>
                            <h4 class="mb-3">Day-2: The jaw dropping view of panggong tso!</h4>
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="img/packages img/destladakh.jpg">
                            <p align="justify">Partake in the breathtaking beauty of the lake of Pangong Tso , during this private day
                                tour from Leh! Travel through India’s scenic natural landscapes as you make your way to
                                the famous lake. Get a chance to admire the lake’s pristine blue waters during an
                                up-close private tour around the area. Meet the friendly ducks and geese that live near
                                the lake or witness migrating birds fly overhead. Before heading back to the city, get
                                your photo taken at the iconic spots where famous Bollywood films, like “3 Idiots”, were
                                shot. Don’t miss out on this chance to immerse yourself in India’s spectacular natural
                                sceneries.
                            </p>
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        ...
                        <div class="media mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <p align="justify">Experienced team helped us to explore ladakkh culture and cuisine a day before our
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p align="justify">We had the best travelling experience with Overseas Holidays . Zabreen, was our
                                    travel Expert, she helped me in planning the trip for Kashmir and Ladakh 13 days and
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p>Tour guide for Leh and Ladakh tour, having experience of more than 10 years.</p>
