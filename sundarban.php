    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Sundarban</h3>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/Sundartree.jpg" alt="">
                                <div class="blog-date">
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        ...
                        <div class="media mb-4">
                            ...
                            <div class="media-body">
                                <h6><a href="">Bisuddhananda Das</a> <small><i>11 Jan 2022</i></small></h6>
                                <p align="justify">Sundarban name comes from the tree name Sundori which is frequently seen here.Sundarban is a bunch of small islands which are intersected by number of rivers.It is mainly famous for Royal Bengal Tiger because this is the only place in the world where Royal Bengal Tigers can be found in forest.Maximum islands here are covered with dense forest.</p>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p align="justify">Sundarbane composes with mangrove trees. Crocodiles used to come to bank and enjoy the sun rays. Moneys and deer are much familar in this forest. After a long way, one used to die to view a single glance of tiger. Hardly one is lucky to view so. After a busy life, sundarban is one of the better place to visit to enjoy a wild experience in home of jungle King.</p>
                                <button class="btn btn-sm btn-outline-primary">Reply</button>
                                <div class="media mt-4">
                                    <img src="img/clients/client2.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                        style="width: 45px;">
                                    <div class="media-body">
                                        <h6><a href="">Shirsendu Mondal</a> <small><i>01 Jan 2045</i></small></h6>
                                        <p align="justify">You can go to some watchtower and try to see more wildlives too.Some local temples are also there in which Bonbibi temple is very famous.So you can see you must add this place to your travel list as soon as possible.</p>
                                        <button class="btn btn-sm btn-outline-primary">Reply</button>
                                    </div>
                                </div>
                            </div>
