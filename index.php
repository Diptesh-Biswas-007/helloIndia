...
<body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="package.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4>
                            <h1 class="display-3 text-white mb-md-4">The journey matters more than the destination</h1>
                            <a href="package.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-4 p-lg-5 my-lg-5">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <img class="img-fluid" src="img/about-2.jpg" alt="" width="240" height="75"> 
                            </div>
                        </div>
                        <a href="package.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Book Now</a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            <h5 class="">India wide Coverage</h5>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/destrajasthan.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="Rajasthan_Block.php">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/destkashmir.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="JammuKashmir_block.php">
                            <h5 class="text-white">Jammu & Kashmir</h5>
                            <span>6 places</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/desttamilnadu.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="Tamilnadu_block.php">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/Puri.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="Odisha_block.php">
                            <h5 class="text-white">Odisha</h5>
                            <span>3 places</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/destgujrat.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="Gujrat.php">
                            <h5 class="text-white">Gujrat</h5>
                            <span>3 places</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="destination-item position-relative overflow-hidden mb-2">
                        <img class="img-fluid" src="img/packages img/destwestbengal1.jpg" alt="">
                        <a class="destination-overlay text-white text-decoration-none" href="westbengal.php">
                            <h5 class="text-white">West Bengal</h5>
                            <span>6 places</span>
                        </a>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;"> National Packages</h6>
                <h1>Choose Your Tour Packages</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/LADAKH.webp" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Ladakh</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="Ladakh.php">Thrilling Leh Ladakh Tour with Pangong Lake</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.8
                                        <small>(1025)</small></h6>
                                        &emsp;&emsp;&emsp;<small class="m-0">40% off</small><h5 class="m-0">INR 22,950</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/tajmahal.jpg" alt="" height="150px">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i
                            ...
                            <a class="h5 text-decoration-none" href="tajmahal.php">Best Selling Golden Triangle Tour</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.1 <small>(650)</small>
                                    </h6>
                                    &emsp;&emsp;&emsp;<small class="m-0">30% off</small><h5 class="m-0">INR 19,340</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/bengal2.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Bengal</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>3 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="">Explore the heart of Indian culture with us </a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.3 <small>(250)</small>
                                    </h6>
                                    &emsp;&emsp;&emsp;<small class="m-0">20% off</small><h5 class="m-0">INR 19,450</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/Chennai.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>South</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>5 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="">Serene South with Coorg and Ooty - Value Added
                                Package</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.1 <small>(320)</small>
                                    </h6>
                                    &emsp;&emsp;&emsp;<small class="m-0">29% off</small><h5 class="m-0">INR 36,100</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/andaman.png" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                            
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Andaman &
                                    Nicobar</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>7 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="andaman.php">Romantic Seaside Holiday in Andaman- Soulmate
                                Special</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.7 <small>(750)</small>
                                    </h6>
                                    &emsp;&emsp;&emsp;<small class="m-0">36% off</small><h5 class="m-0">INR 40,166</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="package-item bg-white mb-2">
                        <img class="img-fluid" src="img/packages img/Sikkim.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i>Sikkim</small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i>4 days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i>2 Person</small>
                            </div>
                            <a class="h5 text-decoration-none" href="">Don't ask for security, ask for adventure - Visit Sikkim</a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.2 <small>(540)</small>
                                    </h6>
                                    &emsp;&emsp;&emsp;<small class="m-0">22% off</small><h5 class="m-0">INR 23,678</h5>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="text-center">
                    ...
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        ...
                        <h5 class="text-truncate">Bishwanath Jana</h5>
                        <span>Travel Guide </span>
                    </div>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/services img/olivia.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">Recently We traveled to Munnar, Alleppey in Kerala through travel triangle. Their staff really supportive. 
                        </p>
                        <h5 class="text-truncate">Olivia Jana</h5>
                        <span>Travel Guide </span>
                    </div>
                </div>
                <div class="text-center">
                    <img class="img-fluid mx-auto" src="img/clients/client1.jpg" style="width: 100px; height: 100px;" >
                    <div class="testimonial-text bg-white p-4 mt-n5">
                        <p class="mt-5">It was a great experience. Hotels location was good, cab driver was undoubtedly excellent.
                        </p>
                ...
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        ...
                        <div class="bg-white p-4">
                            ...
                            <a class="h5 m-0 text-decoration-none" href="">Welcome to Taj Mahal, Standing majestically on the banks of River Yamuna</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        ...
                        <div class="bg-white p-4">
                            ...
                            <a class="h5 m-0 text-decoration-none" href="">The Konark Sun Temple, dedicated to the Hindu sun god Surya</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4 pb-2">
                    <div class="blog-item">
                        ...
                        <div class="bg-white p-4">
                            ...
                            <a class="h5 m-0 text-decoration-none" href="">The Golden Temple , one of the holiest sites in Sikhism located in Punjab, India </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <a class="btn btn-outline-primary btn-square mr-2" href="https://www.linedin.com"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-phone-alt mr-2"></i>+91 7865981142</p>
                <p><i class="fa fa-envelope mr-2"></i>quintetcoder05@gmail.com </p>
                <h6 class="text-white text-uppercase mt-4 mb-3" style="letter-spacing: 5px;">Admin</h6>
                <div class="w-100">
                    <div class="input-group">
                        
                        <div class="input-group-append">
                        <a href="AdminLogin.php" style="text-decoration: none">
            <input id="signup" type="button" value="Admin Login">
            </a>
