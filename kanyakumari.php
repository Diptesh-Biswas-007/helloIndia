...
<head>
    <meta charset="utf-8">
    <title>Kanyakumari.helloIndia.com</title>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Kanyakumari</h3>
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/packages img/vivekananda.jpg" alt="">
                                <div class="blog-date">
                                    <h6 class="font-weight-bold mb-n1">16</h6>
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">Vivekananda Rock Memorial: Tranquil Memorial
                            </h2>
                            <p align="justify"> A Kanyakumari trip would be incomplete without a visit to this famous
                                tourist places in Kanyakumari. As soon as you step off the ferry at this small island
                                where India’s most loved saint Swami Vivekananda attained enlightenment in 1892, you can
                                feel the spiritual vibes and serenity of the place. It is a blissful experience to
                                simply sit and meditate in the quiet Dhyan Mandapam (meditation hall) or gaze at the
                                meeting point of three mighty oceans with wonder. The sunset and sunrise views from the
                                Vivekananda rock make it one of the best places to visit in Kanyakumari. Just 500m off
                                the mainland, the place can be easily reached by a regular ferry service. </p>

                            <h5 class="mb-3">Day-1: Thiruvalluvar Statue: Majestic Saint In Stone</h5>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/packages img/Thiruvalluvar.webp">
                            <p align="justify">Looking for some of the finest Kanyakumari places to visit? Thiruvalluvar
                                Statue is a perfect place for you if you are an architecture enthusiast. Just adjacent
                                to the Vivekananda rock memorial is the towering stone statue of the much revered Tamil
                                poet and philosopher, Thiruvalluvar. The 38-feet high pedestal is symbolic of the 38
                                chapters of virtue in the literary masterpiece, the Tirukkural, while the 133 feet high
                                statue represents the 133 chapters in the book. This is a place of great cultural
                                significance and one of the most popular Kanyakumari sightseeing places.</p>
                            <br>
                            <h5 class="mb-3">Day-2: Padmanabhapuram Palace: Superb Architecture</h5>
                            <img class="img-fluid w-50 float-left mr-4 mb-2"
                                src="img/packages img/Padmanabhapuram-Palace_22nd-oct-400x229.webp">
                            <p align="justify">This alluring 16th century teakwood palace is amongst the top kanyakumari
                                sightseeing places and the finest example of Taccusastra (the ancient science of
                                carpentry). A living proof of the architectural brilliance and rich heritage of the
                                erstwhile kingdom of Travancore, the magnificent interiors of this palace will take your
                                breath away. Right from the entrance where an intricately carved jackfruit tree stands
                                witness to its unparalleled beauty, to the stunning interiors adorned with elaborately
                                carved columns, chairs with Chinese carvings and Belgian mirrors, the palace leaves a
