    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Jaipur</h3>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/packages img/jaipur.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">Visit the astonising Pink city of Jaipur with us</h2>
                            <p align="justify"> The pink city and the capital of Rajasthan is the largest in the state. Founded by
                                Maharaja Sawai Jai Singh in 1727, Jaipur is one of the most popular Rajasthan tourist
                                places in Jaipur. Long list of historic and heritage monuments, swift connectivity from
                                major cities and an amazing city plan where all the streets of the city run from east to
                                west – Jaipur is a marvel to be at. </p>

                            <h5 class="mb-3">Day-1: City Palace of Jaipur</h5>
                            <img class="img-fluid w-50 float-left mr-4 mb-2"
                                src="img/packages img/jaipur city police.jpg">
                            <p align="justify">City Palace has stood at the heart of the Old City of Jaipur for nearly three centuries,
                                shortly after Maharaja Sawai Jai Singh II decided to relocate his court from the city of
                                Amber. Protected by huge guard walls, the fairy-tale-like structure is still the home of
                                Jaipur's modern-day royal family, and is more extravagant and enchanting than you might
                                imagine.

                                City Palace is more than a sand-colored regal abode–it's a sprawling complex of
                                buildings built around a series of landscaped garden courtyards overlooking Jaipur and
                                Lake Palace. The entire property is a stunning display of Rajasthani and Mughal
                                architecture.</p>
                            <h5>Day-2: Hawamahal of jaipur</h5>
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="img/packages img/hawamahal.jpg">
                            <p align="justify">If you had any preconceived notions about how the buildings in Jaipur look, they probably
                                came from Hawa Mahal (Palace of Breeze). It has all of the distinctive architectural
                                features that appear in postcards of the city, from the salmon-pink, honeycombed facade,
                                built to resemble the crown of Hindu god Krishna, to the geometric accents and rows of
                                tiny windows.

                                The landmark was built in 1799 to allow royal ladies to watch festivals on the street
                                without being seen by the public. Its 953 windows allow plenty of breeze to pass
                                through, making it an ideal summer palace.
                            </p>
                            <h5 class="mb-3">Day-3: Amazing forts of Jaipur!!</h5>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/packages img/Amber fort.jpg">
                            <p align="justify">Jaipur is home to one of India's most-visited forts: Amber Fort. Built in the year 1592,
                                the sandstone and marble monolith stands atop a small hill roughly 20 minute's driving
                                distance northeast of the center of Jaipur. It's best known for being a pristine example
                                of Rajasthani architecture. This UNESCO World Heritage Site has a fascinating history of
                                legends, betrayals, and romance–but the best way for tourists to hear these stories is
                                to hire a private guide at the Amber Fort.</p>
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        ...
                        <div class="media mb-4">
                            <img src="img/team-4.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                style="width: 45px;">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p align="justify">Tour guide for Rajasthan and Jaipur, having experience of more than 10 years.</p>
