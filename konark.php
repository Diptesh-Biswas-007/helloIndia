...
<head>
    <meta charset="utf-8">
    <title>Konark.helloIndia.com</title>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Konark</h3>
            ...
            <div class="row">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/packages img/Konarka_Temple.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">Visit the Historical Konark Temple
                            </h2>
                            <p align="justify">A UNESCO World Heritage Site, Konark Sun temple is a striking model of
                                ancient Kalinga artistry and fluidity of ideas. Dedicated to the Sun god, Surya, the
                                first rays of the sun fall on the entrance of the temple. Much of the temple has fallen
                                into rack and ruin but what remains still holds enough charm to captivate. An
                                interpretation of a greater imagination, it has seen empires rise and fall, identities
                                washed away, yet appealing to our sensorium even today.

                                Konark Sun Temple is situated in the northeastern corner of Puri and is dedicated to Sun
                                God. Konark is also known as “Arka kshetra”. There are three images of the Sun God at
                                three different sides of the temple, positioned in the proper direction to catch the
                                rays of the sun in the morning, noon and evening.</p>

                            <h4 class="mb-3">Day-1: Archaeological Museum, Konark</h4>
                            <img class="img-fluid w-50 float-left mr-4 mb-2"
                                src="img/packages img/archaeological-museum-konark.jpg">
                            <p align="justify">The archaeological site museum is situated at a distance of 1.5 km from
                                Konark. The Konark Museum was started in the year 1968 with the purpose of housing the
                                archeological excavations and the fallen sculptures from the Sun Temple. The museum has
                                four galleries displaying 260 various antiquities. The antiquities include various
                                Sculptures, Paintings, Manuscripts and various fallen parts from the Konark Sun Temple.
                                It is a treasure house for historians and art lovers.
                            <h4>Day-2: Konark/Chandrabhaga Beach</h4>
                            <img class="img-fluid w-50 float-right ml-4 mb-2"
                                src="img/packages img/chandrabhaga-beach.jpg">
                            <p align="justify">The Konark Sea Beach is named after Chandrabhaga River which joins sea
                                here. The lengthy stretch of sylvan sands and soothing blue sea rushing in, undulating
                                waves makes the Konark Beach one of the beautiful places to visit in Konark. A leisurely
                                stroll along the beachside is a lovely experience. Tourists can also enjoy beach
                                activities like Sun Bathing, Surfing and many more.
                            </p><br>
                            <h4 class="mb-3">Day-3: Kuruma Buddhist Site</h4>
                            <img class="img-fluid w-50 float-left mr-4 mb-2"
                                src="img/packages img/kuruma-budhhist-site.jpg">
                            <p align="justify">Kuruma is one of the major archaeological excavation sites in Odisha and
                                is mentioned in several Buddhist texts from Ashoka and Ceylon and also appears in the
                                writings of the Chinese traveler Hieun Tsang. The origin of the site is dated to be
                                between 8th-9th century AD and is a must visit for everyone who likes to explore the
                                history of India.</p>
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        ...
                        <div class="media mb-4">
                            ...
                            <div class="media-body">
                                <h6><a href="">Jayanta Das</a> <small><i>03 Sep 2022</i></small></h6>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        ...
                        <p align="justify">Tour guide for Odisha, having experience of more than 10
                            years.
                        </p>
