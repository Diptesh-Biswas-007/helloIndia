...
<head>
    <meta charset="utf-8">
    <title>Bikaner.helloIndia</title>
    ...
    <div class="container-fluid page-header">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Bikaner</h3>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        <div class="blog-item">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/packages img/Bikaner1.jpg" alt="">
                                <div class="blog-date">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">WELCOME TO CAMEL COUNTRY</h2>
                            <p align="justify">Bikaner is home to one of the only two models of the biplane used by the British during
                                World War I. They were presented by the British to Maharaja Ganga Singh, then ruler of
                                the city. Another unique aspect about Bikaner are the sand dunes that are scattered
                                throughout the district, especially from the north-east down to the southern area.
                                Bikaner is situated in the northern region of Rajasthan. </p><br>

                            <h5 class="mb-3">Day-1: NATIONAL RESEARCH CENTRE ON CAMEL</h5>
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="img/packages img/Bikaner CAmel.jpg">
                            <p align="justify">The National Research Centre on Camel is 8 kilometres from the city. This camel research
                                and breeding centre is the only one of its kind in Asia. The centre is spread out over
                                2000 acres of semi-arid land and is managed by the Government of India.

                            </p><br>
                            <h5>Day-2: LALGARH PALACE AND MUSEUM</h5>
                            <img class="img-fluid w-50 float-right ml-4 mb-2" src="img/packages img/Lalgarh.jpg">
                            <p align="justify">Maharaja Ganga Singh commissioned the construction of this majestic palace. This
                                architectural marvel is made entirely of red sandstone and was built in 1902 to
                                commemorate his father, Maharaja Lal Singh. The design was conceptualised by Sir Swinton
                                Jacob, who created this oriental fantasy by blending Rajputana, Islamic and European
                                architecture.
                            </p>
                    ...
                    <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                        ...
                        <div class="media mb-4">
                            <img src="img/team-3.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                style="width: 45px;">
                            <div class="media-body">
                                <h6><a href="">Surath Roy</a> <small><i>03 Sep 2022</i></small></h6>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-white mb-5 py-5 px-4">
                        <img src="img/services img/olivia.jpg"
                            class="img-fluid mx-auto mb-3" style="width: 100px;">
                        <h3 class="text-primary mb-3">Olivia Jana</h3>
                        <p>Tour guide for Rajasthan , having experience of more than 10 years.</p>
